...
public class SortListDemo {
	...
	public static void main(String[] args) {
		...
		List<src1.example.Employee> employees = DataBase.getEmployees();
		...
		employees.stream().sorted(Comparator.comparing(src1.example.Employee::getName)).forEach(System.out::println);
